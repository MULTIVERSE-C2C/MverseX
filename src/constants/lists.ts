...
const KAVA_LIST = 'https://github.com/MULTIVERSE-C2C/MverseX/blob/scroll-showcase/src/constants/tokenLists/KAVA.tokenlist.json'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [UNI_LIST, KAVA_LIST]
